...
path = "/services/scratch/mistis/etouron/"
...
def main(ctx: mlxp.Context)->None:
    ...
    if 1:
        ...
        DNN = BioVisionTransformer(img_size=C_ref.size(2), in_chans = 1, patch_size=patch_size, embed_dim = embed_dim,no_embed_class=True, depth = depth, num_heads=num_heads, chr_seq=chr_seq_16_chr, chr_cen=chr_cen_16_chr, dim=dim, resolution=resolution)
        ...
        # with open(path+f"train_loader_transf_patch_{patch_size}", "wb") as f:
        #     pickle.dump(train_loader, f)
        # with open(path+f"val_loader_transf_patch_{patch_size}", "wb") as f:
        #     pickle.dump(val_loader, f)
        print("loading data loader")
        with open(path+f"train_loader_transf_patch_{patch_size}", "rb") as f:
            train_loader = pickle.load(f)
        with open(path+f"val_loader_transf_patch_{patch_size}", "rb") as f:
